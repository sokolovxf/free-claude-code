...
$RepoArchiveUrl = "https://github.com/sokolovxf/free-claude-code/archive/refs/heads/smart-router-v2.zip"
...
$MuseInstallUrl = "https://raw.githubusercontent.com/sokolovxf/free-claude-code/smart-router-v2/scripts/install-muse.ps1"
$RtkVersion = "0.44.2"
